...
from importer.roster_listener import RosterListener
from model.roster_database import RosterDatabase

DIRECTORY_ROSTER = os.getenv("DIRECTORY_ROSTER", "/home/tom/development/personal/temp")
...
if __name__ == "__main__":
    ...
    if MONITOR_CHANGES == "True":
        RosterListener(roster_importer=importer).listen(DIRECTORY_ROSTER)
